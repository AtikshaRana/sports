...
export default function Page() {
  ...
  return (
    <section className='md:pb-48 hero-banner items-start md:items-center pt-[60px] md:pt-0'>
       <div className={`bgaAbsolute imgchange ${active.isActive ? 'active' : ''}`}>
        <Image
          src={hoveredItem}
          height={1000}
      ...
      <div className="container">
        <div className="logo-wrap max-h-[300px] max-w-[600px] md:max-h-[600px] h-full w-full mx-auto">
