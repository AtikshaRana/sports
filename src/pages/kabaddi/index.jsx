...
export default function index() {
    const img = "https://ss-i.thgim.com/public/incoming/fjzecq/article66165963.ece/alternates/FREE_1200/315491992_516453253718340_937966576626146612_n.jpg"
    const title = "Kabaddi"
    return (
        <div className='md:pb-48'>
          ...
          <div className="container">
            <div className="content py-10 text-center pb-10 lg:pg-20">
              <h1 className=' text-2xl md:text-4xl font-bold mb-3'>Kabaddi</h1>
              <p className='text-white text-lg md:text-xl tracking-widest'>Kabaddi is a contact team sport played between two teams of seven players, originating from India. The objective of the game is for a single player on offense, referred to as a "raider", to run into the opposing team's half of the court, touch out as many of their players and return to their own half of the court, all without being tackled by the defenders in 30 seconds. Points are scored for each player tagged by the raider, while the opposing team earns a point for stopping the raider. Players are taken out of the game if they are touched or tackled, but are brought back in for each point scored by their team from a tag or a tackle.
